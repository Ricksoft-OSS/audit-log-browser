...
<@markup id="css">
  <#-- CSS Library -->
  <@link rel="stylesheet" type="text/css" href="${url.context}/res/resources/audit-log-browser-share-jar/css/lib/bootstrap.min.css"/>
  <@link rel="stylesheet" type="text/css" href="${url.context}/res/resources/audit-log-browser-share-jar/css/lib/bootstrap-grid.min.css"/>
  <@link rel="stylesheet" type="text/css" href="${url.context}/res/resources/audit-log-browser-share-jar/css/lib/bootstrap-reboot.min.css"/>
  <#-- CSS Dependencies -->
  <@link rel="stylesheet" type="text/css" href="${url.context}/res/resources/audit-log-browser-share-jar/css/auditlogbrowser/normal.css"/>
</@>
<@markup id="js">
   <#-- JavaScript Library -->
