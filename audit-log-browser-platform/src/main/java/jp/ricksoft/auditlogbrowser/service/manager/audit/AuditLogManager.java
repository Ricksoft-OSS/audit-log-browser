package jp.ricksoft.auditlogbrowser.service.manager.audit;
...
public class AuditLogManager {
    ...
    public List<Map<String, Object>> getAuditLogs(AuditQueryParameters auditQueryParameters) {
        return this.getAuditLogs(auditQueryParameters, 100);
    }
     ...
     * @author ebihara.yuki
     */
    public List<Map<String, Object>> getAuditLogs(AuditQueryParameters auditQueryParameters, int maxUnit) {

        // Audit log query callback function setting.
        MyAuditQueryCallback callback = new MyAuditQueryCallback();

        // Execute Query
        auditService.auditQuery(callback, auditQueryParameters, maxUnit);
    ...
    public LocalDateTime getOldestLoggedDateTime() {
        ...
        List<Map<String, Object>> entries = this.getAuditLogs(
                this.buildAuditQueryParameters(null, null, null, null, null),
                1);
    ...
    public AuditQueryParameters buildAuditQueryParameters(Long fromTime, Long toTime, Long fromId,
